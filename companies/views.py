...
from registration.models import Tenant, Domain  # GlobalUser, TenantUser
...
#             tenant_subdomain = payload[
#                 'tenant'] if 'tenant' in locals() else 'default'  # Handle case if tenant is not found
#             frontend_url = f"https://{tenant_subdomain}.fastrasuite.com/email-verify-status"
